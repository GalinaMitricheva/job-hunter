...
CREATE TABLE IF NOT EXISTS settings (
  ...
  search_schedule TEXT NOT NULL DEFAULT 'manual',
  search_schedule_time TEXT DEFAULT '08:00',
  linkedin_email TEXT,
  linkedin_password_encrypted TEXT,
  company_urls TEXT NOT NULL DEFAULT '[]',
  cv_template TEXT NOT NULL DEFAULT 'classic',
  headless_browser INTEGER NOT NULL DEFAULT 1,
